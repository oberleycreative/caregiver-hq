...
;(function ($) {
    ...
    /**
     * modalpress constructor
     */
    function modalpress(modal, options) {
     ...
     * Build required DOM
     */
    modalpress.prototype.buildDOM = function () {
     ...
     */
    modalpress.prototype.addEventListeners = function () {
        var self = this;
     ...
     * Open modal window
     */
    modalpress.prototype.open = function () {
		...
		/*
		$('#modalpress-' + id + ' .modalpress-content').html('<div style="text-align:center;padding:50px;"><img src="' + ajax_object.modalpress_images + 'ajax-loader.gif"></div>');
			var data = {
					 'action' : 'load_modal_content',
					 'slug' : id					 
					
					}
			jQuery('#modalpress-' + id + ' .modalpress-content').hide();	
			$.get(ajax_object.ajax_url, data,function(response){
				$('#modalpress-' + id + ' .modalpress-content').html(response).fadeIn();
     ...
     * Close modal window
     */
    modalpress.prototype.close = function () {
        // check if animation is complete
        if (this.busy) {
            return;
        }
        ...
        $.fn[pluginName] = function (opts) {
            ...
            this.each(function (i, e) {
                ...
                if ($e.data(pluginName) == null) {
                    instance = new modalpress($e, opts);
    ...
    $(document).ready(function () {
        /**
         * data-modalpress-target opens a modal window with a special id without hash change.
         */
         ...
         * They should have the 'modalpress' class attribute.
         * Also you can pass params into the modal throw the data-modalpress-options attribute.
         * data-modalpress-options must be a valid JSON string.
         */
