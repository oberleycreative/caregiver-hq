...
jQuery(function($){
	...
	var morph =
		'<div class="sf-settings-wrapper morph-button morph-button-fixed morph-button-modal morph-button-modal-2">' +
			...
			'<div class="morph-content">' +
				'<i class="fa fa-times"></i><i class="fa fa-question-circle"></i>' +
				'<form class="sf-menu-item-form" action="" method="post" enctype="multipart/form-data">' +
					'<div>' +
						'<h3>Menu Item Attached image</h3>' +
						'<div class="sf-info sf-anim"><i class="fa fa-info-circle"></i> Please choose image to show on the left side of item. Will be scaled</div>' +
						'<div class="sf-media"><span class="sf-image-cont"></span><span class="sf-choose-image">Select Image</span></div>' +
						'<input class="sf-short sf-media-input" type="hidden" name="img"/>' +
			'</div>' +
					'<div><h3>Font Awesome class</h3>' +
						'<div class="sf-info sf-anim"><i class="fa fa-info-circle"></i> You can add icon before item. See <a href="http://fortawesome.github.io/Font-Awesome/cheatsheet/" target="_blank">cheatsheet</a>. Don\'t use with attached image</div>' +
						'<input class="sf-short" type="text" name="icon"/>' +
					'</div>' +
					'<div><h3>Second line</h3>' +
						'<div class="sf-info sf-anim"><i class="fa fa-info-circle"></i> Brief description under menu item</div>' +
						'<input type="text" name="sline"/>' +
					'</div>' +
					'<div><h3>Chapter</h3>' +
					'<div class="sf-info sf-anim"><i class="fa fa-info-circle"></i> Chapter title that goes above menu item</div>' +
					'<input class="sf-short" type="text" name="chapter"/>' +
					'</div>' +
	...
	$('#menu-management .menu-item').each(function(){
		var $t = $(this);
		$t.find( '.item-title' ).append( $(morph).attr('data-sf-item-id', $t.attr('id')) );
	});
	...
	$( '#menu-management .sf-choose-image' ).on( 'click', function( event ){
		...
		file_frame.on( 'select', function() {
			...
			$t.prev().html( '<img src="' + attachment.url + '"/>' )
