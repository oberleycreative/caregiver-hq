...
function sf_menus_admin() {
	...
	wp_enqueue_script( 'sf-menus-admin-js', plugins_url('/js/menu-admin.js', __FILE__) , array( 'jquery' ) , '1.0.0' , true );
...
function sf_save_item_fn() {
	...
	update_post_meta( $menu_item_id, SF_ITEM_META , $serialized_settings );
